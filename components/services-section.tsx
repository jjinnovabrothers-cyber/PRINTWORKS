...
const SERVICES: Service[] = [
  {
    id: 1, title: "Servicios de Impresion", icon: <PrinterIcon />,
    description: "Productos basicos de impresion de alta calidad para tu negocio o proyecto personal. Tecnologia de punta y acabados profesionales que hacen brillar tu marca.",
    coverImage: "/images/products/volantes.jpg",
    whatsappMsg: "Hola PRINTWORKS! Quiero cotizar servicios de impresion.",
    items: [
      { name: "Volantes", image: "/images/products/volantes.jpg" },
      { name: "Tarjetas de Presentacion", image: "/images/products/tarjetas.jpg" },
      { name: "Stickers y Etiquetas", image: "/images/products/stickers.jpg" },
      { name: "Pendones y Banners", image: "/images/products/pendones.jpg" },
      { name: "Cuadros Decorativos", image: "/images/products/cuadro-anime.jpg" },
      { name: "Retratos Personalizados", image: "/images/products/cuadro-retrato.jpg" },
    ],
  },
  {
    id: 2, title: "Material P.O.P", icon: <TagIcon />,
    description: "Material publicitario en punto de venta que impulsa tus ventas. Exhibidores, cenefas, rompe-trafico y senalizacion profesional para captar la atencion de tus clientes.",
    coverImage: "/images/products/material-pop.jpg",
    whatsappMsg: "Hola PRINTWORKS! Quiero cotizar Material P.O.P.",
    items: [
      { name: "Exhibidores POP", image: "/images/products/material-pop.jpg" },
      { name: "Roll Ups", image: "/images/products/pendones.jpg" },
      { name: "Avisos Publicitarios", image: "/images/products/volantes.jpg" },
      { name: "Senalizacion", image: "/images/products/stickers.jpg" },
    ],
  },
  {
    id: 3, title: "Souvenirs Promocionales", icon: <GiftIcon />,
    description: "Articulos personalizados que dejan huella. Mugs, cuadros en MDF, canvas, placas y regalos corporativos con la imagen de tu marca o tus recuerdos mas especiales.",
    ...
    items: [
      ...
      { name: "Cuadros Infantiles en MDF", image: "/images/products/cuadro-kids.jpg" },
      { name: "Cuadros de Mascotas", image: "/images/products/cuadro-mascota.jpg" },
      { name: "Cuadros Artisticos", image: "/images/products/cuadro-anime.jpg" },
      { name: "Retratos en Canvas", image: "/images/products/cuadro-retrato.jpg" },
      { name: "Articulos Corporativos", image: "/images/products/souvenirs.jpg" },
    ],
  },
  {
    id: 4, title: "Produccion Litografica", icon: <BookIcon />,
    description: "Produccion litografica offset de alto volumen con acabados premium. Revistas, catalogos, libros, empaques y todo tipo de impresos a gran escala.",
    coverImage: "/images/products/litografia.jpg",
    whatsappMsg: "Hola PRINTWORKS! Quiero cotizar produccion litografica.",
    items: [
      { name: "Revistas y Catalogos", image: "/images/products/litografia.jpg" },
      { name: "Libros y Manuales", image: "/images/products/litografia.jpg" },
      { name: "Plegables y Brochures", image: "/images/products/volantes.jpg" },
      { name: "Empaques y Cajas", image: "/images/products/material-pop.jpg" },
      { name: "Papeleria Corporativa", image: "/images/products/tarjetas.jpg" },
    ],
  },
  {
    id: 5, title: "E-Commerce", icon: <CartIcon />,
    description: "Llevamos tu negocio al mundo digital con tiendas en linea profesionales. Catalogo de productos, pasarelas de pago e integracion con redes sociales.",
    coverImage: "/images/products/ecommerce.jpg",
    whatsappMsg: "Hola PRINTWORKS! Quiero cotizar una tienda E-Commerce.",
    items: [
      { name: "Tienda Online Profesional", image: "/images/products/ecommerce.jpg" },
      { name: "Catalogo Digital", image: "/images/products/tarjetas.jpg" },
      { name: "Gestion de Redes Sociales", image: "/images/products/stickers.jpg" },
    ],
  },
]
...
function ServiceModal({ service, onClose }: { service: Service; onClose: () => void }) {
  ...
  const handleSubmit = () => {
    ...
    window.open(`https://wa.me/573187092130?text=${m}`, "_blank")
  }
  ...
  return (<>
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/80 px-4 py-8 backdrop-blur-sm sm:py-12" onClick={onClose}>
      <div className="relative w-full max-w-3xl rounded-2xl border border-[rgba(34,197,94,0.2)] bg-[#0d1a0d] shadow-[0_0_60px_rgba(34,197,94,0.06)]" onClick={(e) => e.stopPropagation()}>
        <button onClick={onClose} className="absolute right-4 top-4 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-[rgba(255,255,255,0.1)] text-[#9ca3af] hover:bg-[rgba(255,255,255,0.2)] hover:text-white" aria-label="Cerrar">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
        </button>
